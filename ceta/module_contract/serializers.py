...
from .models import *
from ceta.module_human_resources.serializers import EmployeeSerializer
...
class ContractSerializer(serializers.ModelSerializer):  
    manager_ct = EmployeeSerializer()
    fk_id_client = ClientSerializer()
